...
namespace MedievalOverhaul
{
    public class IncidentWorker_GolemImpactor : IncidentWorker
    {
        ...
        public override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            LordMaker.MakeNewLord(list[0].Faction, (LordJob)new LordJob_SleepThenMechanoidsDefend([innerThing], list[0].Faction, DefendRadius, dropPodLocation, false, false), map, (IEnumerable<Pawn>)list);
