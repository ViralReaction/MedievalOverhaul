...
{
    public class Listing_TreeThingFilter_FuelCustom : Listing_Tree
    {
        ...
        public Listing_TreeThingFilter_FuelCustom(ThingFilter filter, ThingFilter parentFilter,
            IEnumerable<ThingDef> forceHiddenDefs, IEnumerable<SpecialThingFilterDef> forceHiddenFilters,
            List<ThingDef> suppressSmallVolumeTags, QuickSearchFilter searchFilter, List<CompRefuelableCustom> cachedFuelBuildings)
        {
            this.filter = filter;
