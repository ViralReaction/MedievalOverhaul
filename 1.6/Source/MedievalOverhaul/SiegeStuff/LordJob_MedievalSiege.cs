...
public class LordJob_MedievalSiege : LordJob_Siege
{
	...
	public LordJob_MedievalSiege(Faction faction, IntVec3 siegeSpot, float blueprintPoints)
	{
	...
	public override StateGraph CreateGraph()
	{
		...
		LordToil_MedievalSiege lordToil_Siege = new LordToil_MedievalSiege(siegeSpot, blueprintPoints);
